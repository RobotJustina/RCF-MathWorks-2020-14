...
void ex_FH_uPUneNGWNjiMxeN5lfg(real_T*x1,real_T*x2,real_T*f,real_T*bv1,real_T*
...
size_t*n1,const size_t*n2){ex_FH_uPUneNGWNjiMxeN5lfg(x1,x2,f,bv1,bv2,x1s,x2s,
...
fs,const size_t*n1,const size_t*n2){ex_FH_uPUneNGWNjiMxeN5lfg(x1,x2,f,bv1,bv2,
...
x1s,x2s,fs,n1,n2);}static void ex_FH_uPUneNGWNjiMxeN5lfg(real_T*x1,real_T*x2,
real_T*f,real_T*bv1,real_T*bv2,const real_T*x1s,const real_T*x2s,const real_T*
...
;ex_F4LajttG6uGtbXBJgUNQpW(x1,x2,f,n1,n2);bv1[0]=x1[0];bv1[1]=x1[n1-1];bv2[0]=
...
ex_FEqJOwWsoqtBeLOBScc47f(fi,H1,G1,numEdges1,bin1,H2,G2,numEdges2,bin2,f,mode1
...
){ex_FEqJOwWsoqtBeLOBScc47f(fi,H1,G1,numEdges1,bin1,H2,G2,numEdges2,bin2,f,
...
,f,mode1,mode2,n1,n2);}static void ex_FEqJOwWsoqtBeLOBScc47f(real_T*fi,const
real_T*H1,const real_T*G1,const size_t*ex_koMwWVZ5kdO_cmNynyQJr7,const size_t*
ex_V5M9clt1oOxmhHN3Ehciw4,const real_T*H2,const real_T*G2,const size_t*
ex___TPtFdMIMdka1RE4RrHK5,const size_t*ex_kwmw_QOG8uhxiTvKA_xa1Y,const real_T*
f,const boolean_T*mode1,const boolean_T*mode2,const size_t*
ex_VMjU_zotmLxndPNpPFuHG9,const size_t*ex_VtVCgVxNcpd_YmPNQN4Ru7,const
boolean_T ex_V0dauSHHy5d6_D42s3Aeag,const boolean_T ex_kMAXUIgm88xvaunhJ2st8X)
{const size_t n1= *ex_VMjU_zotmLxndPNpPFuHG9;const size_t n2= *
ex_VtVCgVxNcpd_YmPNQN4Ru7;size_t numEdges1= *ex_koMwWVZ5kdO_cmNynyQJr7;size_t
numEdges2= *ex___TPtFdMIMdka1RE4RrHK5;size_t bin1= *ex_V5M9clt1oOxmhHN3Ehciw4;
size_t bin2= *ex_kwmw_QOG8uhxiTvKA_xa1Y;size_t bin=bin1+n1*bin2;size_t
ex_FnrjFNs9eQp9V5vCxPaoKw,ex_FRuIUemzxbdhfqkjXhoyK7;size_t
ex_Fb8WfqABMs_vcqFzZf37Fa,ex_k4UiAV7JSYpMjHsHDM_wV6;fi[0]=0.0;if(
