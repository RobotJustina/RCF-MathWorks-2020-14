...
const void*mech,int*modeVector);const void*mMech;};typedef struct
...
runtimeDerivedValuesBundle,const int*modeVector,size_t numTargets,const struct
CTargetTag*cTargets,double*stateVector,void*neDiagMgr);PmfMessageId
sm_core_computeStateVectorCustom(const SmMechanismDelegate*mechDelegate,const
struct RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,const int*
modeVector,size_t numTargets,const struct CTargetTag*cTargets,boolean_T
doPosSatPhase1,boolean_T doVelSat,double*stateVector,void*neDiagMgr);unsigned
int sm_core_checkAssembly(const SmMechanismDelegate*mechDelegate,const struct
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,const double*
stateVector,const int*modeVector,SmSizeTVector*posViolationConstraintIndices,
SmSizeTVector*velViolationConstraintIndices,SmSizeTVector*
singViolationConstraintIndices);PmfMessageId sm_core_projectState(boolean_T
doCheckFirst,const SmMechanismDelegate*mechDelegate,const struct
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,const int*modeVector,
const double*inputVector,const double*inputDotVector,const double*
discreteStateVector,double*solverStateVector,void*neDiagMgr);void
sm_core_computeRedundantConstraintEquations(SmMechanismDelegate*mechDelegate,
const struct RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle);struct
RuntimeDerivedValuesBundleTag{SmRealVector mDoubles;SmIntVector mInts;};
typedef struct RuntimeDerivedValuesBundleTag RuntimeDerivedValuesBundle;void
...
mPAssertFcn;NeDaeMethod mDerivativeFcn;NeDaeMethod mOutputFcn;NeDaeMethod
