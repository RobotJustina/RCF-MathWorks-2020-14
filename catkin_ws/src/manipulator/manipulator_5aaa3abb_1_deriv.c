...
PmfMessageId manipulator_5aaa3abb_1_deriv(const RuntimeDerivedValuesBundle *rtdv,
  ...
  *neDiagMgr)
{
  ...
  if (0 != 0) {
    return sm_ssci_recordRunTimeError(
      ...
      "The Length parameter of the 'manipulator/Manipulator/Variable Brick Solid' block is zero. For the calculation of solid dimensions from mass, the block requires a nonzero value.",
      neDiagMgr);
  }
  ...
  if (0 != 0) {
    return sm_ssci_recordRunTimeError(
      ...
      "The Width parameter of the 'manipulator/Manipulator/Variable Brick Solid' block is zero. For the calculation of solid dimensions from mass, the block requires a nonzero value.",
      neDiagMgr);
  }
  ...
  if (!(input[0] != xx[108] || xx[110] == xx[108]) ? 1 : 0 != 0) {
    return sm_ssci_recordRunTimeError(
      ...
      "The zero mass of 'manipulator/Manipulator/Variable Brick Solid' is incompatible with the nonzero center of mass.",
      neDiagMgr);
  }
  ...
  if (xx[116] != xx[108] || (xx[126] == xx[108] && xx[109] == xx[108] && xx[114]
    ...
    return sm_ssci_recordRunTimeError(
      ...
      "The rigid component containing 'manipulator/Manipulator/Variable Brick Solid' has invalid zero total mass and nonzero first moment of mass.",
      neDiagMgr);
  }
  ...
  if (ii[0] != 0) {
    return sm_ssci_recordRunTimeError(
      ...
      "'manipulator/Manipulator/la_7_joint' has a degenerate mass distribution on its follower side.",
      neDiagMgr);
  }
  ...
  if (ii[0] != 0) {
    return sm_ssci_recordRunTimeError(
      "sm:compiler:messages:simulationErrors:DegenerateMass",
      "'manipulator/Manipulator/la_6_joint' has a degenerate mass distribution on its follower side.",
      neDiagMgr);
  }
  ...
  if (ii[0] != 0) {
    return sm_ssci_recordRunTimeError(
      "sm:compiler:messages:simulationErrors:DegenerateMass",
      "'manipulator/Manipulator/la_5_joint' has a degenerate mass distribution on its follower side.",
      neDiagMgr);
  }
  ...
  if (ii[0] != 0) {
    return sm_ssci_recordRunTimeError(
      "sm:compiler:messages:simulationErrors:DegenerateMass",
      "'manipulator/Manipulator/la_4_joint' has a degenerate mass distribution on its follower side.",
      neDiagMgr);
  }
  ...
  if (ii[0] != 0) {
    return sm_ssci_recordRunTimeError(
      "sm:compiler:messages:simulationErrors:DegenerateMass",
      "'manipulator/Manipulator/la_3_joint' has a degenerate mass distribution on its follower side.",
      neDiagMgr);
  }
  ...
  if (ii[0] != 0) {
    return sm_ssci_recordRunTimeError(
      "sm:compiler:messages:simulationErrors:DegenerateMass",
      "'manipulator/Manipulator/la_2_joint' has a degenerate mass distribution on its follower side.",
      neDiagMgr);
  }
  ...
  if (ii[0] != 0) {
    return sm_ssci_recordRunTimeError(
      "sm:compiler:messages:simulationErrors:DegenerateMass",
      "'manipulator/Manipulator/la_1_joint' has a degenerate mass distribution on its follower side.",
      neDiagMgr);
  }
