...
mRTWModifiedTimeStamp;};typedef struct NeParameterBundleTag{PmIntVector
mLogicalParameters;PmIntVector mIntegerParameters;PmIntVector mIndexParameters
;PmRealVector mRealParameters;}NeParameterBundle;typedef struct
...
;typedef struct NeProfilerTag NeProfiler;typedef struct SlSparseMatrixTag{
PmSparsityPattern*mPattern;PmRealVector*mPr;}SlSparseMatrix;typedef struct
SLMatricesTag{boolean_T mIsYAffineTermUpdated;boolean_T mIsXP0AffineTermUpdated
;size_t mOffsetX0InD;size_t mOffsetU0InD;size_t mSlDaeNumDiscreteMajor;size_t
mSlDaeNumCache;PmRealVector mAffineY;PmRealVector mAffineXP0;PmRealVector mYX0
;PmRealVector mYU0;SlSparseMatrix mDxddotDxd;SlSparseMatrix mDxddotDu;
SlSparseMatrix mDyDxd;SlSparseMatrix mDyDu;SlSparseMatrix mDxaDxd;
SlSparseMatrix mDxaDu;PmIntVector mMode;PmIntVector mMajor;PmIntVector mCache;
}SLMatrices;typedef union NeDaeMethodOutputTag{PmSparsityPattern mM_P;
...
PmIntVector mIASSERT;PmRealVector mSO;PmRealVector mSP;PmIntVector mMODE;
PmIntVector mUDOT_REQ;PmRealVector mDELAYS;PmBoolVector mDXF_V_X;PmBoolVector
mDUF_V_X;PmRealVector mOBS_EXP;PmRealVector mOBS_ACT;PmRealVector mEQ_TOL;}
...
NE_DAE_METHOD_EQ_TOL,NE_NUM_DAE_METHODS}NeDaeMethodId;typedef enum
...
NeSystemInput*);typedef PmfMessageId(*NeDaeLinearizeFcn)(const NeDae*,const
NeSystemInput*,PmRealVector*,NeuDiagnosticManager*);typedef NeDaeMethodOutput*
...
mNumInitialAssertRanges;size_t mNumSamples;size_t mNumDelays;size_t
...
mNumIo[NUM_IO_TYPES];const NeDsIoInfo*mIo[NUM_IO_TYPES];NeChecksum*mChecksum;
...
NeDaeLinearizeFcn mLinearizeFcn;PmfMessageId(*mInitializeFcn)(NeDae*dae,
NeModelParameters mp,NeuDiagnosticManager*mgr);void(*mSolverFailureNotify)(
NeDae*dae,size_t num_consecutive_failures);void(*mSetupLoggerFcn)(const NeDae*
,NeLoggerBuilder*);int32_T(*mLogFcn)(const NeDae*,const NeSystemInput*,
PmRealVector*);void(*mGenerateFcn)(const NeDae*,const NeCgParams*,NeCgResults*
);const SLMatrices**(*mSwitchedLinearDataFcn)(const NeDae*);NeDaeMakeOutputFcn
mMakeOutput[NE_NUM_DAE_METHODS];NeDaeFreeOutputFcn mFreeOutput[
NE_NUM_DAE_METHODS];NeRealFunctorFcn mRealFunctorFcn;void(*mSetOutputFunction)
(const NeDae*,size_t outputFunctionIndex);void(*mStartOutputLoop)(const NeDae*
);NeCustomData*(*mGetCustomDataFcn)(const NeDae*);PmfMessageId(*
mSetCustomDataFcn)(const NeCustomData*,const NeDae*,NeuDiagnosticManager*mgr);
};PMF_DEPLOY_STATIC PmfMessageId ne_dae_linearize(const NeDae*dae,const
NeSystemInput*input,PmRealVector*LinJacobian,NeuDiagnosticManager*mgr){return
dae->mLinearizeFcn(dae,input,LinJacobian,mgr);}PMF_DEPLOY_STATIC PmfMessageId
ne_dae_residuals(const NeDae*daePtr,const NeSystemInput*inputPtr,PmRealVector*
...
(const NeDae*dae,NeDaeMethodId id,const NeSystemInput*input,NeDaeMethodOutput*
