...
PmSparsityPattern*pm_kAWy4EaHbpxVbT_qyApDbv){;;;memcpy(
...
boolean_T pm__ZRI70SuGwhmamUtcsoyxS(const PmSparsityPattern*
pm__56dBn4vKXWjZ1nclFRYZB,const PmSparsityPattern*pm_kAWy4EaHbpxVbT_qyApDbv){;
;;return(memcmp(pm__56dBn4vKXWjZ1nclFRYZB->mJc,pm_kAWy4EaHbpxVbT_qyApDbv->mJc,
sizeof(int32_T)*(pm__56dBn4vKXWjZ1nclFRYZB->mNumCol+1))==0)&&(memcmp(
pm__56dBn4vKXWjZ1nclFRYZB->mIr,pm_kAWy4EaHbpxVbT_qyApDbv->mIr,sizeof(int32_T)*
((size_t)(pm__56dBn4vKXWjZ1nclFRYZB)->mJc[(pm__56dBn4vKXWjZ1nclFRYZB)->mNumCol
]))==0);}PmSparsityPattern*pm_FQMLyYzCQ5CtgHjze1nNJP(const PmSparsityPattern*
...
pm_FvcKvutPfxG9Xe1kjs7gg0(PmSparsityPattern*pm__6H5I5OnY3KoY5YVL6mLgG,
PmAllocator*pm_FbYb_iLqY2hwZTVlVaiqJY){;{void*pm_kk06poLCQlh5i5Yv6GSh7e=(
pm__6H5I5OnY3KoY5YVL6mLgG->mJc);if(pm_kk06poLCQlh5i5Yv6GSh7e!=0){(
pm_FbYb_iLqY2hwZTVlVaiqJY)->mFreeFcn(pm_FbYb_iLqY2hwZTVlVaiqJY,
pm_kk06poLCQlh5i5Yv6GSh7e);}};if(pm__6H5I5OnY3KoY5YVL6mLgG->mIr!=NULL){{void*
pm_kk06poLCQlh5i5Yv6GSh7e=(pm__6H5I5OnY3KoY5YVL6mLgG->mIr);if(
pm_kk06poLCQlh5i5Yv6GSh7e!=0){(pm_FbYb_iLqY2hwZTVlVaiqJY)->mFreeFcn(
pm_FbYb_iLqY2hwZTVlVaiqJY,pm_kk06poLCQlh5i5Yv6GSh7e);}};}}void
pm_VYooJBURCwKrVu6RXzQZ_5(PmSparsityPattern*pm__6H5I5OnY3KoY5YVL6mLgG,
PmAllocator*pm__8zlSpb2Hixod149p2zadR){;pm_FvcKvutPfxG9Xe1kjs7gg0(
...
*sizeof(int32_T));}};return pm_kKo5ZT7hO5CIhDFBar7kG3;}PmSparsityPattern*
pm_FFniD_kRQg_JWTYc5cmjGs(size_t pm__GeNF2llSxSVWmZa9ocEGK,size_t
pm__yjwm3JEVFhagux1_YE9b5,PmAllocator*pm_FbYb_iLqY2hwZTVlVaiqJY){
...
int32_T));;;return pm__srK5LmyWw42ZyPnbOWDWJ;}PmSparsityPattern*
pm_FhqtSrxlPotrcypQHJ9Dcq(size_t pm__lqjegyKuwStj56WZLiC_e,size_t n,
...
pm__nP_wNlJUxWHWLytmZ4pL0->mIr;size_t pm_kwrB3ZoKf7OufTHWaHJV7a=0;;for(
pm_kwrB3ZoKf7OufTHWaHJV7a=0;pm_kwrB3ZoKf7OufTHWaHJV7a<
