...
void manipulator_5aaa3abb_1_gateway(void)
{
  ...
  manipulator_5aaa3abb_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("manipulator/Manipulator/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
