...
// Conversions between SL_Bus_ekf_std_msgs_Float64MultiArray and std_msgs::Float64MultiArray

void convertFromBus(std_msgs::Float64MultiArray* msgPtr, SL_Bus_ekf_std_msgs_Float64MultiArray const* busPtr)
{
...
void convertToBus(SL_Bus_ekf_std_msgs_Float64MultiArray* busPtr, std_msgs::Float64MultiArray const* msgPtr)
{
  const std::string rosMessageType("std_msgs/Float64MultiArray");
...
// Conversions between SL_Bus_ekf_std_msgs_MultiArrayDimension and std_msgs::MultiArrayDimension

void convertFromBus(std_msgs::MultiArrayDimension* msgPtr, SL_Bus_ekf_std_msgs_MultiArrayDimension const* busPtr)
{
...
void convertToBus(SL_Bus_ekf_std_msgs_MultiArrayDimension* busPtr, std_msgs::MultiArrayDimension const* msgPtr)
{
  const std::string rosMessageType("std_msgs/MultiArrayDimension");
...
// Conversions between SL_Bus_ekf_std_msgs_MultiArrayLayout and std_msgs::MultiArrayLayout

void convertFromBus(std_msgs::MultiArrayLayout* msgPtr, SL_Bus_ekf_std_msgs_MultiArrayLayout const* busPtr)
{
...
void convertToBus(SL_Bus_ekf_std_msgs_MultiArrayLayout* busPtr, std_msgs::MultiArrayLayout const* msgPtr)
{
  const std::string rosMessageType("std_msgs/MultiArrayLayout");
