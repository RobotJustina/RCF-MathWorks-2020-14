...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_control_std_msgs_MultiArrayDimension_
#define DEFINED_TYPEDEF_FOR_SL_Bus_control_std_msgs_MultiArrayDimension_
...
typedef struct {
  ...
  uint32_T Size;
  uint32_T Stride;
} SL_Bus_control_std_msgs_MultiArrayDimension;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_control_std_msgs_MultiArrayLayout_
#define DEFINED_TYPEDEF_FOR_SL_Bus_control_std_msgs_MultiArrayLayout_
...
typedef struct {
  ...
  SL_Bus_control_std_msgs_MultiArrayDimension Dim[16];

  // IsVarLen=1:VarLenCategory=length:VarLenElem=Dim
  SL_Bus_ROSVariableLengthArrayInfo Dim_SL_Info;
} SL_Bus_control_std_msgs_MultiArrayLayout;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_control_std_msgs_Float64MultiArray_
#define DEFINED_TYPEDEF_FOR_SL_Bus_control_std_msgs_Float64MultiArray_
...
typedef struct {
  ...
  // MsgType=std_msgs/MultiArrayLayout
  SL_Bus_control_std_msgs_MultiArrayLayout Layout;
} SL_Bus_control_std_msgs_Float64MultiArray;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_control_std_msgs_Float32MultiArray_
#define DEFINED_TYPEDEF_FOR_SL_Bus_control_std_msgs_Float32MultiArray_
...
typedef struct {
  ...
  // MsgType=std_msgs/MultiArrayLayout
  SL_Bus_control_std_msgs_MultiArrayLayout Layout;
} SL_Bus_control_std_msgs_Float32MultiArray;
...
#ifndef typedef_emxArray_char_T_control_T
#define typedef_emxArray_char_T_control_T

typedef struct emxArray_char_T emxArray_char_T_control_T;

#endif                                 //typedef_emxArray_char_T_control_T
...
#ifndef typedef_emxArray_real_T_control_T
#define typedef_emxArray_real_T_control_T

typedef struct emxArray_real_T emxArray_real_T_control_T;

#endif                                 //typedef_emxArray_real_T_control_T
...
#ifndef typedef_ssoOm1dpzkll0ActLkI75EE_contr_T
#define typedef_ssoOm1dpzkll0ActLkI75EE_contr_T

typedef struct tag_ssoOm1dpzkll0ActLkI75EE ssoOm1dpzkll0ActLkI75EE_contr_T;

#endif                                 //typedef_ssoOm1dpzkll0ActLkI75EE_contr_T
...
#ifndef typedef_sb1GSy5uAZojAgyRiXnSERH_contr_T
#define typedef_sb1GSy5uAZojAgyRiXnSERH_contr_T

typedef struct tag_sb1GSy5uAZojAgyRiXnSERH sb1GSy5uAZojAgyRiXnSERH_contr_T;

#endif                                 //typedef_sb1GSy5uAZojAgyRiXnSERH_contr_T
...
struct tag_s2BTGTsPQneIOsjQTihd6PE
{
  ...
  uint8_T DataFormat;
  real_T JointPositionLimits[14];
  ssoOm1dpzkll0ActLkI75EE_contr_T Bodies[11];
  sb1GSy5uAZojAgyRiXnSERH_contr_T Joints[11];
};

#endif                                 //struct_tag_s2BTGTsPQneIOsjQTihd6PE

#ifndef typedef_s2BTGTsPQneIOsjQTihd6PE_contr_T
#define typedef_s2BTGTsPQneIOsjQTihd6PE_contr_T

typedef struct tag_s2BTGTsPQneIOsjQTihd6PE s2BTGTsPQneIOsjQTihd6PE_contr_T;

#endif                                 //typedef_s2BTGTsPQneIOsjQTihd6PE_contr_T

#ifndef typedef_e_cell_wrap_control_T
#define typedef_e_cell_wrap_control_T

typedef struct {
  real_T f1[36];
} e_cell_wrap_control_T;

#endif                                 //typedef_e_cell_wrap_control_T

#ifndef typedef_rigidBodyJoint_control_T
#define typedef_rigidBodyJoint_control_T

typedef struct {
  emxArray_char_T_control_T *Type;
  emxArray_real_T_control_T *MotionSubspace;
  real_T JointToParentTransform[16];
  real_T ChildToJointTransform[16];
  real_T JointAxisInternal[3];
} rigidBodyJoint_control_T;

#endif                                 //typedef_rigidBodyJoint_control_T
...
typedef struct {
  real_T Index;
  rigidBodyJoint_control_T JointInternal;
  real_T ParentIndex;
  real_T SpatialInertia[36];
...
#ifndef typedef_emxArray_e_cell_wrap_control_T
#define typedef_emxArray_e_cell_wrap_control_T

typedef struct {
  e_cell_wrap_control_T *data;
  int32_T *size;
  int32_T allocatedSize;
  int32_T numDimensions;
  boolean_T canFreeData;
...
#endif                                 //typedef_emxArray_e_cell_wrap_control_T
