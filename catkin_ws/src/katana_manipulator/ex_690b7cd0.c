...
ex_kTwu6FGHauCWW1q7bqdYqX(real_T*fi,const real_T*basis1,const real_T*
...
n2,const size_t n3,const size_t n4,const size_t ex_F_tm5fod4xxuguhS49BSQm,
const boolean_T ex_kMAXUIgm88xvaunhJ2st8X,const real_T*work1,const size_t*
work2);static void ex__s5fN6i6XodjdLeaZS47pR(real_T*x1,real_T*x2,real_T*x3,
real_T*x4,real_T*fx,const real_T*x1s,const real_T*x2s,const real_T*x3s,const
real_T*x4s,const real_T*fs,const size_t n1,const size_t n2,const size_t n3,
const size_t n4);void tlu2_4d_akima_nearest_process(real_T*x1,real_T*x2,real_T
*x3,real_T*x4,real_T*fx1,const real_T*x1s,const real_T*x2s,const real_T*x3s,
const real_T*x4s,const real_T*fs,const size_t*n1,const size_t*n2,const size_t*
n3,const size_t*n4){ex__s5fN6i6XodjdLeaZS47pR(x1,x2,x3,x4,fx1,x1s,x2s,x3s,x4s,
fs,*n1,*n2,*n3,*n4);}void tlu2_4d_akima_nearest_process_custom_function_(void*
...
const real_T*)((const void*const*)in)[2];const real_T*x4s=(const real_T*)((
const void*const*)in)[3];const real_T*fs=(const real_T*)((const void*const*)in
)[4];const size_t*n1=(const size_t*)((const void*const*)in)[5];const size_t*n2
=(const size_t*)((const void*const*)in)[6];const size_t*n3=(const size_t*)((
...
*fx=(real_T*)((void**)out)[4];tlu2_4d_akima_nearest_process(x1,x2,x3,x4,fx,x1s
,x2s,x3s,x4s,fs,n1,n2,n3,n4);}void tlu2_4d_akima_linear_process(real_T*x1,
real_T*x2,real_T*x3,real_T*x4,real_T*fx1,const real_T*x1s,const real_T*x2s,
const real_T*x3s,const real_T*x4s,const real_T*fs,const size_t*n1,const size_t
*n2,const size_t*n3,const size_t*n4){ex__s5fN6i6XodjdLeaZS47pR(x1,x2,x3,x4,fx1
,x1s,x2s,x3s,x4s,fs,*n1,*n2,*n3,*n4);}void
...
*)((void**)out)[2];real_T*x4=(real_T*)((void**)out)[3];real_T*fx=(real_T*)((
void**)out)[4];tlu2_4d_akima_linear_process(x1,x2,x3,x4,fx,x1s,x2s,x3s,x4s,fs,
n1,n2,n3,n4);}static void ex__s5fN6i6XodjdLeaZS47pR(real_T*x1,real_T*x2,real_T
*x3,real_T*x4,real_T*fx1,const real_T*x1s,const real_T*x2s,const real_T*x3s,
const real_T*x4s,const real_T*fs,const size_t n1,const size_t n2,const size_t
n3,const size_t n4){const size_t ex_F3nVSXkoDK8VeeL5OmY0_B=4;size_t
ex__jP7F4Fk5ExlWmUH2CnO0p[4];const real_T*ex_VToqGBrino_cYuTsjsb5G7[4];const
size_t n=n1*n2*n3*n4;real_T*ex_VsAv95vpmFp3i1E54_unM9=pmf_malloc(n*sizeof(
real_T));size_t ex_FzsezTJVFaKAhHt_a3UeWF;size_t ex_kdATsbeSp_x8_DV4Ry4QD0;
size_t ex_FP2u25405gSWeDgzM8AO0G;real_T*ex_V1PpSt9JShK3bL1Bw6asF1;size_t*
ex_VVfVnPxpzepMZXSq9ZSsjY;real_T*ex_VorZCi5_B5tOa9oe3bnRf5;
ex__jP7F4Fk5ExlWmUH2CnO0p[0]=n1;ex__jP7F4Fk5ExlWmUH2CnO0p[1]=n2;
ex__jP7F4Fk5ExlWmUH2CnO0p[2]=n3;ex__jP7F4Fk5ExlWmUH2CnO0p[3]=n4;
ex_VToqGBrino_cYuTsjsb5G7[0]=x1;ex_VToqGBrino_cYuTsjsb5G7[1]=x2;
ex_VToqGBrino_cYuTsjsb5G7[2]=x3;ex_VToqGBrino_cYuTsjsb5G7[3]=x4;memcpy(x1,x1s,
n1*sizeof(real_T));memcpy(x2,x2s,n2*sizeof(real_T));memcpy(x3,x3s,n3*sizeof(
real_T));memcpy(x4,x4s,n4*sizeof(real_T));memcpy(ex_VsAv95vpmFp3i1E54_unM9,fs,
n*sizeof(real_T));ex_F_6wSEEsvm_1cTAuvwDt9B(x1,x2,x3,x4,
ex_VsAv95vpmFp3i1E54_unM9,n1,n2,n3,n4);ex_FJUlENJSohGphDc_Rf36LU(
...
);ex_VorZCi5_B5tOa9oe3bnRf5=ex_VQMmQUcKA3_3ei3Owj7WVV(fx1);
ex_kEWp_Qwr9TpuV5h0iCW4f_(ex_F3nVSXkoDK8VeeL5OmY0_B,ex__jP7F4Fk5ExlWmUH2CnO0p,
ex_VToqGBrino_cYuTsjsb5G7,ex_VsAv95vpmFp3i1E54_unM9,&ex_V1PpSt9JShK3bL1Bw6asF1
[0],&ex_VVfVnPxpzepMZXSq9ZSsjY[0],&ex_VorZCi5_B5tOa9oe3bnRf5[0]);pmf_free(
ex_VsAv95vpmFp3i1E54_unM9);pmf_free(ex_V1PpSt9JShK3bL1Bw6asF1);pmf_free(
ex_VVfVnPxpzepMZXSq9ZSsjY);}void tlu2_4d_akima_nearest_value(real_T*fi,const
...
const real_T*basisDerivative3,const size_t*bin3,const real_T*basis4,const
real_T*basisDerivative4,const size_t*bin4,const real_T*fx,const size_t*n1,
const size_t*n2,const size_t*n3,const size_t*n4,const real_T*work1,const size_t
*work2){ex_kTwu6FGHauCWW1q7bqdYqX(fi,basis1,basisDerivative1,*bin1,basis2,
basisDerivative2,*bin2,basis3,basisDerivative3,*bin3,basis4,basisDerivative4,*
bin4,fx,*n1,*n2,*n3,*n4,0,false,work1,work2);}void
tlu2_4d_akima_nearest_value_custom_function_(void*out,const void*in){const
real_T*basis1=(const real_T*)((const void*const*)in)[0];const real_T*
basisDerivative1=(const real_T*)((const void*const*)in)[1];const size_t*bin1=(
const size_t*)((const void*const*)in)[2];const real_T*basis2=(const real_T*)((
const void*const*)in)[3];const real_T*basisDerivative2=(const real_T*)((const
void*const*)in)[4];const size_t*bin2=(const size_t*)((const void*const*)in)[5]
;const real_T*basis3=(const real_T*)((const void*const*)in)[6];const real_T*
basisDerivative3=(const real_T*)((const void*const*)in)[7];const size_t*bin3=(
const size_t*)((const void*const*)in)[8];const real_T*basis4=(const real_T*)((
const void*const*)in)[9];const real_T*basisDerivative4=(const real_T*)((const
void*const*)in)[10];const size_t*bin4=(const size_t*)((const void*const*)in)[
11];const real_T*fx=(const real_T*)((const void*const*)in)[12];const size_t*n1
=(const size_t*)((const void*const*)in)[13];const size_t*n2=(const size_t*)((
const void*const*)in)[14];const size_t*n3=(const size_t*)((const void*const*)
in)[15];const size_t*n4=(const size_t*)((const void*const*)in)[16];const real_T
*work1=(const real_T*)((const void*const*)in)[17];const size_t*work2=(const
size_t*)((const void*const*)in)[18];real_T*fi=(real_T*)out;
tlu2_4d_akima_nearest_value(fi,basis1,basisDerivative1,bin1,basis2,
basisDerivative2,bin2,basis3,basisDerivative3,bin3,basis4,basisDerivative4,
bin4,fx,n1,n2,n3,n4,work1,work2);}void tlu2_4d_akima_linear_value(real_T*fi,
const real_T*basis1,const real_T*basisDerivative1,const size_t*bin1,const
real_T*basis2,const real_T*basisDerivative2,const size_t*bin2,const real_T*
basis3,const real_T*basisDerivative3,const size_t*bin3,const real_T*basis4,
const real_T*basisDerivative4,const size_t*bin4,const real_T*fx,const size_t*
n1,const size_t*n2,const size_t*n3,const size_t*n4,const real_T*work1,const
size_t*work2){ex_kTwu6FGHauCWW1q7bqdYqX(fi,basis1,basisDerivative1,*bin1,
basis2,basisDerivative2,*bin2,basis3,basisDerivative3,*bin3,basis4,
basisDerivative4,*bin4,fx,*n1,*n2,*n3,*n4,1,false,work1,work2);}void
tlu2_4d_akima_linear_value_custom_function_(void*out,const void*in){const
real_T*basis1=(const real_T*)((const void*const*)in)[0];const real_T*
basisDerivative1=(const real_T*)((const void*const*)in)[1];const size_t*bin1=(
const size_t*)((const void*const*)in)[2];const real_T*basis2=(const real_T*)((
const void*const*)in)[3];const real_T*basisDerivative2=(const real_T*)((const
...
*work1=(const real_T*)((const void*const*)in)[17];const size_t*work2=(const
size_t*)((const void*const*)in)[18];real_T*fi=(real_T*)out;
tlu2_4d_akima_linear_value(fi,basis1,basisDerivative1,bin1,basis2,
basisDerivative2,bin2,basis3,basisDerivative3,bin3,basis4,basisDerivative4,
bin4,fx,n1,n2,n3,n4,work1,work2);}void tlu2_4d_akima_nearest_derivatives(
...
real_T*basis3,const real_T*basisDerivative3,const size_t*bin3,const real_T*
basis4,const real_T*basisDerivative4,const size_t*bin4,const real_T*fx,const
size_t*n1,const size_t*n2,const size_t*n3,const size_t*n4,const real_T*work1,
const size_t*work2){ex_kTwu6FGHauCWW1q7bqdYqX(fi,basis1,basisDerivative1,*bin1
,basis2,basisDerivative2,*bin2,basis3,basisDerivative3,*bin3,basis4,
basisDerivative4,*bin4,fx,*n1,*n2,*n3,*n4,0,true,work1,work2);}void
tlu2_4d_akima_nearest_derivatives_custom_function_(void*out,const void*in){
const real_T*basis1=(const real_T*)((const void*const*)in)[0];const real_T*
basisDerivative1=(const real_T*)((const void*const*)in)[1];const size_t*bin1=(
const size_t*)((const void*const*)in)[2];const real_T*basis2=(const real_T*)((
const void*const*)in)[3];const real_T*basisDerivative2=(const real_T*)((const
void*const*)in)[4];const size_t*bin2=(const size_t*)((const void*const*)in)[5]
...
*work1=(const real_T*)((const void*const*)in)[17];const size_t*work2=(const
size_t*)((const void*const*)in)[18];real_T*fi=(real_T*)out;
tlu2_4d_akima_nearest_derivatives(fi,basis1,basisDerivative1,bin1,basis2,
basisDerivative2,bin2,basis3,basisDerivative3,bin3,basis4,basisDerivative4,
bin4,fx,n1,n2,n3,n4,work1,work2);}void tlu2_4d_akima_linear_derivatives(real_T
*fi,const real_T*basis1,const real_T*basisDerivative1,const size_t*bin1,const
real_T*basis2,const real_T*basisDerivative2,const size_t*bin2,const real_T*
basis3,const real_T*basisDerivative3,const size_t*bin3,const real_T*basis4,
const real_T*basisDerivative4,const size_t*bin4,const real_T*fx,const size_t*
n1,const size_t*n2,const size_t*n3,const size_t*n4,const real_T*work1,const
size_t*work2){ex_kTwu6FGHauCWW1q7bqdYqX(fi,basis1,basisDerivative1,*bin1,
basis2,basisDerivative2,*bin2,basis3,basisDerivative3,*bin3,basis4,
basisDerivative4,*bin4,fx,*n1,*n2,*n3,*n4,1,true,work1,work2);}void
...
*work1=(const real_T*)((const void*const*)in)[17];const size_t*work2=(const
size_t*)((const void*const*)in)[18];real_T*fi=(real_T*)out;
tlu2_4d_akima_linear_derivatives(fi,basis1,basisDerivative1,bin1,basis2,
basisDerivative2,bin2,basis3,basisDerivative3,bin3,basis4,basisDerivative4,
bin4,fx,n1,n2,n3,n4,work1,work2);}static void ex_kTwu6FGHauCWW1q7bqdYqX(real_T
*fi,const real_T*ex_Vl61InPOzylYgiebES6ELs,const real_T*
ex_FMWNpeuUHEGegPasHZICvW,const size_t bin1,const real_T*
ex_kB9XB9hzwwW7Vu4shvxxya,const real_T*ex_FztrEwsuKLWtXHBYTAffgh,const size_t
bin2,const real_T*ex__laKwhSBF10XcXh2QbGZxl,const real_T*
ex_k_lASBgCHSpV_ixifFx5vQ,const size_t bin3,const real_T*
ex__Q9yozQvPAKfXeWWDJqbpI,const real_T*ex_FazJmVqWh8l7XmZX0eMuT7,const size_t
bin4,const real_T*fx1,const size_t n1,const size_t n2,const size_t n3,const
size_t n4,const size_t ex_F_tm5fod4xxuguhS49BSQm,const boolean_T
ex_kMAXUIgm88xvaunhJ2st8X,const real_T*work1,const size_t*work2){const size_t n
=n1*n2*n3*n4;const size_t ex_F3nVSXkoDK8VeeL5OmY0_B=4;size_t
ex__jP7F4Fk5ExlWmUH2CnO0p[4];const real_T**ex_kB4aOAnByNCbf5JZPcoQy5=0;const
real_T**ex_FNyrrBDfkJhIjyNSa2fMBz=0;const size_t ex__NJXN1LXJ3dhZPDo3_p2LH=1;
real_T*basis[4];real_T*basisDerivative1[4];real_T*basisDerivative2[4];real_T*
basisDerivative3[4];real_T*basisDerivative4[4];size_t ex__I2IEgdElv80cD1Kv0uRpM
[1];size_t ex__bBTzednxRh0WT2E2HNmTx[1];size_t ex_VTU42MKlyy4vayjUvcNV_7[1];
size_t ex_kyiLb15hdytNaHHfMTtx2o[1];size_t*ex_Vic4f_t1_8lMdPxTHOuua8[4];real_T
*ex_V1PpSt9JShK3bL1Bw6asF1;size_t*ex_VVfVnPxpzepMZXSq9ZSsjY;real_T*
ex_VorZCi5_B5tOa9oe3bnRf5=ex_VQMmQUcKA3_3ei3Owj7WVV(fx1);
ex__jP7F4Fk5ExlWmUH2CnO0p[0]=n1;ex__jP7F4Fk5ExlWmUH2CnO0p[1]=n2;
ex__jP7F4Fk5ExlWmUH2CnO0p[2]=n3;ex__jP7F4Fk5ExlWmUH2CnO0p[3]=n4;basis[0]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_Vl61InPOzylYgiebES6ELs);basis[1]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_kB9XB9hzwwW7Vu4shvxxya);basis[2]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex__laKwhSBF10XcXh2QbGZxl);basis[3]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex__Q9yozQvPAKfXeWWDJqbpI);basisDerivative1[0]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_FMWNpeuUHEGegPasHZICvW);basisDerivative1[1]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_kB9XB9hzwwW7Vu4shvxxya);basisDerivative1[2]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex__laKwhSBF10XcXh2QbGZxl);basisDerivative1[3]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex__Q9yozQvPAKfXeWWDJqbpI);basisDerivative2[0]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_Vl61InPOzylYgiebES6ELs);basisDerivative2[1]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_FztrEwsuKLWtXHBYTAffgh);basisDerivative2[2]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex__laKwhSBF10XcXh2QbGZxl);basisDerivative2[3]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex__Q9yozQvPAKfXeWWDJqbpI);basisDerivative3[0]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_Vl61InPOzylYgiebES6ELs);basisDerivative3[1]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_kB9XB9hzwwW7Vu4shvxxya);basisDerivative3[2]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_k_lASBgCHSpV_ixifFx5vQ);basisDerivative3[3]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex__Q9yozQvPAKfXeWWDJqbpI);basisDerivative4[0]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_Vl61InPOzylYgiebES6ELs);basisDerivative4[1]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_kB9XB9hzwwW7Vu4shvxxya);basisDerivative4[2]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex__laKwhSBF10XcXh2QbGZxl);basisDerivative4[3]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_FazJmVqWh8l7XmZX0eMuT7);ex__I2IEgdElv80cD1Kv0uRpM
[0]=bin1;ex__bBTzednxRh0WT2E2HNmTx[0]=bin2;ex_VTU42MKlyy4vayjUvcNV_7[0]=bin3;
ex_kyiLb15hdytNaHHfMTtx2o[0]=bin4;ex_Vic4f_t1_8lMdPxTHOuua8[0]=
ex__I2IEgdElv80cD1Kv0uRpM;ex_Vic4f_t1_8lMdPxTHOuua8[1]=
ex__bBTzednxRh0WT2E2HNmTx;ex_Vic4f_t1_8lMdPxTHOuua8[2]=
ex_VTU42MKlyy4vayjUvcNV_7;ex_Vic4f_t1_8lMdPxTHOuua8[3]=
ex_kyiLb15hdytNaHHfMTtx2o;ex_V1PpSt9JShK3bL1Bw6asF1=ex_VQMmQUcKA3_3ei3Owj7WVV(
work1);ex_VVfVnPxpzepMZXSq9ZSsjY=ex__ge8CPdYTqKVfmxfN0MdXT(work2);if(!
...
ex__I__tR3HVGtUdmAFtUcU_G(ex_F3nVSXkoDK8VeeL5OmY0_B,ex__jP7F4Fk5ExlWmUH2CnO0p,
ex_kB4aOAnByNCbf5JZPcoQy5,ex_F_tm5fod4xxuguhS49BSQm+1,&
ex_VorZCi5_B5tOa9oe3bnRf5[0],basisDerivative4,&ex_V1PpSt9JShK3bL1Bw6asF1[0],&
ex_VVfVnPxpzepMZXSq9ZSsjY[0],ex__NJXN1LXJ3dhZPDo3_p2LH,
ex_FNyrrBDfkJhIjyNSa2fMBz,ex_Vic4f_t1_8lMdPxTHOuua8,&fi[3]);}}
