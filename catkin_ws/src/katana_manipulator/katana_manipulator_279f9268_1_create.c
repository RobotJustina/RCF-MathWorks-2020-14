...
int32_T sm_ssci_logFcn_codeGen(const NeDae *dae,
  ...
  PmRealVector *output);
extern const NeAssertData katana_manipulator_279f9268_1_assertData[];
extern const NeZCData katana_manipulator_279f9268_1_ZCData[];
void katana_manipulator_279f9268_1_computeRuntimeParameters(
  const double *runtimeRootVariables,
  double *runtimeParameters);
void katana_manipulator_279f9268_1_validateRuntimeParameters(
  const double *runtimeParameters,
  int32_T *assertSatisfactionFlags);
void katana_manipulator_279f9268_1_computeAsmRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
void katana_manipulator_279f9268_1_computeSimRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
PmfMessageId katana_manipulator_279f9268_1_compDerivs(
...
PmfMessageId katana_manipulator_279f9268_1_numJacPerturbLoBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId katana_manipulator_279f9268_1_numJacPerturbHiBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId katana_manipulator_279f9268_1_checkDynamics(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId katana_manipulator_279f9268_1_compOutputsDyn(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId katana_manipulator_279f9268_1_compOutputsKin(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId katana_manipulator_279f9268_1_compOutputs (
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId katana_manipulator_279f9268_1_computeAsmModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId katana_manipulator_279f9268_1_computeSimModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId katana_manipulator_279f9268_1_computeZeroCrossings(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
void katana_manipulator_279f9268_1_setTargets(
...
void katana_manipulator_279f9268_1_resetSimStateVector(const void *mech, double *
  stateVector);
void katana_manipulator_279f9268_1_initializeTrackedAngleState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  ...
  double *stateVector,
  void *neDiagMgr);
void katana_manipulator_279f9268_1_computeDiscreteState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  double *stateVector);
void katana_manipulator_279f9268_1_adjustPosition(
  const void *mech,
  const double *dofDeltas,
  double *stateVector);
void katana_manipulator_279f9268_1_perturbAsmJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  ...
  double *stateVector);
void katana_manipulator_279f9268_1_perturbSimJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void katana_manipulator_279f9268_1_perturbFlexibleBodyState(
  const void *mech,
  size_t stageIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void katana_manipulator_279f9268_1_computePosDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *matrix);
void katana_manipulator_279f9268_1_computeVelDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  const double *stateVector,
  int partialType,
  double *matrix);
void katana_manipulator_279f9268_1_projectPartiallyTargetedPos(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *stateVector);
void katana_manipulator_279f9268_1_propagateMotion(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  double *motionData);
size_t katana_manipulator_279f9268_1_computeAssemblyError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  ...
  const double *motionData,
  double *error);
size_t katana_manipulator_279f9268_1_computeAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  ...
  const double *motionData,
  double *J);
size_t katana_manipulator_279f9268_1_computeFullAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  const double *motionData,
  double *J);
int katana_manipulator_279f9268_1_isInKinematicSingularity(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  const int *modeVector,
  const double *motionData);
PmfMessageId katana_manipulator_279f9268_1_convertStateVector(
  const void *asmMech,
  ...
  void *neDiagMgr);
void katana_manipulator_279f9268_1_constructStateVector(
  const void *mech,
...
void katana_manipulator_279f9268_1_extractSolverStateVector(
  const void *mech,
  const double *fullStateVector,
  double *solverStateVector);
int katana_manipulator_279f9268_1_isPositionViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
int katana_manipulator_279f9268_1_isVelocityViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
PmfMessageId katana_manipulator_279f9268_1_projectStateSim(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const int *modeVector,
  ...
  double *stateVector,
  void *neDiagMgr);
void katana_manipulator_279f9268_1_computeConstraintError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
...
void katana_manipulator_279f9268_1_resetModeVector(const void *mech, int
  *modeVector);
boolean_T katana_manipulator_279f9268_1_hasJointDisToNormModeChange(
  const void *mech,
  const int *prevModeVector,
  const int *modeVector);
PmfMessageId katana_manipulator_279f9268_1_performJointDisToNormModeChange(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *prevModeVector,
  const int *modeVector,
  ...
  double *stateVector,
  void *neDiagMgr);
PmfMessageId katana_manipulator_279f9268_1_onModeChangedCutJoints(
  const void *mech,
  const int *prevModeVector,
  int *modeVector,
  double *stateVector,
  void *neDiagMgr);
PmfMessageId katana_manipulator_279f9268_1_assemble(const double *u, double
  *udot, double *x,
  NeuDiagnosticManager *neDiagMgr)
{
  (void) x;
  ...
  const NeParameterBundle *paramBundle)
{
  ...
  if (smData->mRuntimeParameterScalars.mN == 0)
    return;
  katana_manipulator_279f9268_1_computeRuntimeParameters(
    runtimeRootVariables,
    smData->mRuntimeParameterScalars.mX);
  katana_manipulator_279f9268_1_computeAsmRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
    &dae->mPrivateData->mAsmRuntimeDerivedValuesBundle);
  katana_manipulator_279f9268_1_computeSimRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  (void) systemInput;
  (void) neDiagMgr;
  katana_manipulator_279f9268_1_validateRuntimeParameters(
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mCachedDerivativesAvailable)
    ...
    errorId = katana_manipulator_279f9268_1_compDerivs(
      &smData->mSimRuntimeDerivedValuesBundle,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = katana_manipulator_279f9268_1_numJacPerturbLoBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = katana_manipulator_279f9268_1_numJacPerturbHiBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  errorId = katana_manipulator_279f9268_1_compOutputs(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mM.mX,
    systemInput->mU.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = katana_manipulator_279f9268_1_computeSimModeVector(
    systemInput->mU.mX,
    systemInput->mU.mX + 8,
    systemInput->mV.mX + 8,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  double errorResult = 0.0;
  return
    katana_manipulator_279f9268_1_computeZeroCrossings(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mU.mX,
    systemInput->mU.mX + 8,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (errorId == NULL && smData->mDoCheckDynamics) {
    double result = 0.0;
    errorId = katana_manipulator_279f9268_1_checkDynamics(
      &smData->mSimRuntimeDerivedValuesBundle,
      systemInput->mX.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 8,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mAssemblyModeVector.mN > 0) {
    errorId = katana_manipulator_279f9268_1_computeAsmModeVector(
      systemInput->mU.mX,
      systemInput->mU.mX + 8,
      systemInput->mV.mX + 8,
  ...
  katana_manipulator_279f9268_1_checkTargets(
    &smData->mSimRuntimeDerivedValuesBundle,
  ...
  void initStateVector(NeDaePrivateData *smData)
{
  ...
  const CTarget targets[14] = {
    { 0, 79, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, true,
    ...
    { 0, 110, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, true,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 110, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, true,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 128, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, true,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 128, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, true,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 146, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, true,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 146, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, true,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 164, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, true,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 164, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, true,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 183, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, true,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },
...
static void initAsserts(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumParamAsserts > 0) {
    const NeAssertData *ad = katana_manipulator_279f9268_1_assertData;
    size_t i;
...
static void initZeroCrossings(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumZeroCrossings > 0) {
    const NeZCData *zcd = katana_manipulator_279f9268_1_ZCData;
    size_t i;
  ...
  void initVariables(NeDaePrivateData *smData)
{
  const char *varFullPaths[14] = {
    "Subsystem.katana_motor1_pan_joint.Rz.q",
    "Subsystem.katana_motor1_pan_joint.Rz.w",
    "Subsystem.katana_motor2_lift_joint.Rz.q",
    "Subsystem.katana_motor2_lift_joint.Rz.w",
    "Subsystem.katana_motor3_lift_joint.Rz.q",
    "Subsystem.katana_motor3_lift_joint.Rz.w",
    "Subsystem.katana_motor4_lift_joint.Rz.q",
    "Subsystem.katana_motor4_lift_joint.Rz.w",
    "Subsystem.katana_motor5_wrist_roll_joint.Rz.q",
    "Subsystem.katana_motor5_wrist_roll_joint.Rz.w",
    "Subsystem.katana_l_finger_joint.Rz.q",
    "Subsystem.katana_l_finger_joint.Rz.w",
    "Subsystem.katana_r_finger_joint.Rz.q",
    "Subsystem.katana_r_finger_joint.Rz.w"
  };

  const char *varObjects[14] = {
    "katana_manipulator/Subsystem/katana_motor1_pan_joint",
    "katana_manipulator/Subsystem/katana_motor1_pan_joint",
    "katana_manipulator/Subsystem/katana_motor2_lift_joint",
    "katana_manipulator/Subsystem/katana_motor2_lift_joint",
    "katana_manipulator/Subsystem/katana_motor3_lift_joint",
    "katana_manipulator/Subsystem/katana_motor3_lift_joint",
    "katana_manipulator/Subsystem/katana_motor4_lift_joint",
    "katana_manipulator/Subsystem/katana_motor4_lift_joint",
    "katana_manipulator/Subsystem/katana_motor5_wrist_roll_joint",
    "katana_manipulator/Subsystem/katana_motor5_wrist_roll_joint",
    "katana_manipulator/Subsystem/katana_l_finger_joint",
    "katana_manipulator/Subsystem/katana_l_finger_joint",
    "katana_manipulator/Subsystem/katana_r_finger_joint",
    "katana_manipulator/Subsystem/katana_r_finger_joint"
  };
  ...
  void initIoInfo(NeDaePrivateData *smData)
{
  const char *inputPortPaths[8] = {
    "Subsystem.Variable_Brick_Solid.mi",
    "Subsystem.katana_l_finger_joint.ti",
    "Subsystem.katana_motor1_pan_joint.ti",
    "Subsystem.katana_motor2_lift_joint.ti",
    "Subsystem.katana_motor3_lift_joint.ti",
    "Subsystem.katana_motor4_lift_joint.ti",
    "Subsystem.katana_motor5_wrist_roll_joint.ti",
    "Subsystem.katana_r_finger_joint.ti"
  };
  ...
  const char *outputPortPaths[7] = {
    "Subsystem.katana_l_finger_joint.q",
    "Subsystem.katana_motor1_pan_joint.q",
    "Subsystem.katana_motor2_lift_joint.q",
    "Subsystem.katana_motor3_lift_joint.q",
    "Subsystem.katana_motor4_lift_joint.q",
    "Subsystem.katana_motor5_wrist_roll_joint.q",
    "Subsystem.katana_r_finger_joint.q"
  };
  ...
  void initAssemblyDelegate(SmMechanismDelegate *delegate)
{
  ...
  const SmSizePair jointToStageIdx[10] = {
    { 31, 0 }, { 50, 6 }, { 78, 9 }, { 79, 7 }, { 92, 1 }, { 110, 2 },

    { 128, 3 }, { 146, 4 }, { 164, 5 }, { 183, 8 }
  };
  ...
  delegate->mSetTargets = katana_manipulator_279f9268_1_setTargets;
  delegate->mResetStateVector =
    katana_manipulator_279f9268_1_resetAsmStateVector;
  delegate->mInitializeTrackedAngleState =
    katana_manipulator_279f9268_1_initializeTrackedAngleState;
  delegate->mComputeDiscreteState =
    katana_manipulator_279f9268_1_computeDiscreteState;
  delegate->mAdjustPosition = katana_manipulator_279f9268_1_adjustPosition;
  delegate->mPerturbJointPrimitiveState =
    katana_manipulator_279f9268_1_perturbAsmJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState = NULL;
  delegate->mComputePosDofBlendMatrix =
    katana_manipulator_279f9268_1_computePosDofBlendMatrix;
  delegate->mComputeVelDofBlendMatrix =
    katana_manipulator_279f9268_1_computeVelDofBlendMatrix;
  delegate->mProjectPartiallyTargetedPos =
    katana_manipulator_279f9268_1_projectPartiallyTargetedPos;
  delegate->mPropagateMotion = katana_manipulator_279f9268_1_propagateMotion;
  delegate->mComputeAssemblyError =
    katana_manipulator_279f9268_1_computeAssemblyError;
  delegate->mComputeAssemblyJacobian =
    katana_manipulator_279f9268_1_computeAssemblyJacobian;
  delegate->mComputeFullAssemblyJacobian =
    katana_manipulator_279f9268_1_computeFullAssemblyJacobian;
  delegate->mIsInKinematicSingularity =
    katana_manipulator_279f9268_1_isInKinematicSingularity;
  delegate->mConvertStateVector =
    katana_manipulator_279f9268_1_convertStateVector;
  ...
  void initSimulationDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mResetStateVector =
    katana_manipulator_279f9268_1_resetSimStateVector;
  delegate->mInitializeTrackedAngleState = NULL;
  delegate->mComputeDiscreteState = NULL;
  delegate->mAdjustPosition = NULL;
  delegate->mPerturbJointPrimitiveState =
    katana_manipulator_279f9268_1_perturbSimJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState =
    katana_manipulator_279f9268_1_perturbFlexibleBodyState;
  ...
  delegate->mConstructStateVector =
    katana_manipulator_279f9268_1_constructStateVector;
  delegate->mExtractSolverStateVector =
    katana_manipulator_279f9268_1_extractSolverStateVector;
  delegate->mIsPositionViolation =
    katana_manipulator_279f9268_1_isPositionViolation;
  delegate->mIsVelocityViolation =
    katana_manipulator_279f9268_1_isVelocityViolation;
  delegate->mProjectStateSim = katana_manipulator_279f9268_1_projectStateSim;
  delegate->mComputeConstraintError =
    katana_manipulator_279f9268_1_computeConstraintError;
  delegate->mResetModeVector = katana_manipulator_279f9268_1_resetModeVector;
  delegate->mHasJointDisToNormModeChange =
    katana_manipulator_279f9268_1_hasJointDisToNormModeChange;
  delegate->mPerformJointDisToNormModeChange =
    katana_manipulator_279f9268_1_performJointDisToNormModeChange;
  delegate->mOnModeChangedCutJoints =
    katana_manipulator_279f9268_1_onModeChangedCutJoints;
  delegate->mMech = NULL;
}
