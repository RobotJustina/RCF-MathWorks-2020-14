#include "pm_std.h"
#include "lang_std.h"
size_t ex_VzC4wVDNwRO2VyQZ1TOBFP(real_T*H,real_T*G,const real_T*x,const size_t
n,const real_T t,const boolean_T ex_V0dauSHHy5d6_D42s3Aeag);size_t
ex_FSBp3lkv5gpCXL2yT9vLNh(const real_T*x,const size_t n,const real_T t);void
...
const real_T t,const boolean_T ex_V0dauSHHy5d6_D42s3Aeag){size_t bin;real_T
ex__1EFbmUY_TlBhLJH5Hc_gX;real_T ex_FfqZXxZ8jd0hY5oz1HhyOh,
ex_FBrilljiwYdvbLmVDDMXd7;if(t<x[0]){bin=0;ex_FfqZXxZ8jd0hY5oz1HhyOh=x[0];
ex_FBrilljiwYdvbLmVDDMXd7=x[1];ex__1EFbmUY_TlBhLJH5Hc_gX=
...
;}if(ex_V0dauSHHy5d6_D42s3Aeag){H[0]=(ex_FBrilljiwYdvbLmVDDMXd7-t)/
...
t>x[n-1]){bin=n-2;ex_FfqZXxZ8jd0hY5oz1HhyOh=x[n-2];ex_FBrilljiwYdvbLmVDDMXd7=x
