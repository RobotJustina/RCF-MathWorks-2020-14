...
//
#ifndef RTW_HEADER_justina_ekf_types_h_
#define RTW_HEADER_justina_ekf_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_justina_ekf_std_msgs_MultiArrayDimension_
#define DEFINED_TYPEDEF_FOR_SL_Bus_justina_ekf_std_msgs_MultiArrayDimension_
...
typedef struct {
  ...
  uint32_T Size;
  uint32_T Stride;
} SL_Bus_justina_ekf_std_msgs_MultiArrayDimension;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_justina_ekf_std_msgs_MultiArrayLayout_
#define DEFINED_TYPEDEF_FOR_SL_Bus_justina_ekf_std_msgs_MultiArrayLayout_
...
typedef struct {
  ...
  SL_Bus_justina_ekf_std_msgs_MultiArrayDimension Dim[16];

  // IsVarLen=1:VarLenCategory=length:VarLenElem=Dim
  SL_Bus_ROSVariableLengthArrayInfo Dim_SL_Info;
} SL_Bus_justina_ekf_std_msgs_MultiArrayLayout;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_justina_ekf_std_msgs_Float64MultiArray_
#define DEFINED_TYPEDEF_FOR_SL_Bus_justina_ekf_std_msgs_Float64MultiArray_
...
typedef struct {
  ...
  // MsgType=std_msgs/MultiArrayLayout
  SL_Bus_justina_ekf_std_msgs_MultiArrayLayout Layout;
} SL_Bus_justina_ekf_std_msgs_Float64MultiArray;
...
#ifndef typedef_emxArray_char_T_justina_ekf_T
#define typedef_emxArray_char_T_justina_ekf_T

typedef struct emxArray_char_T emxArray_char_T_justina_ekf_T;

#endif                                 //typedef_emxArray_char_T_justina_ekf_T
...
#ifndef typedef_emxArray_real_T_justina_ekf_T
#define typedef_emxArray_real_T_justina_ekf_T

typedef struct emxArray_real_T emxArray_real_T_justina_ekf_T;

#endif                                 //typedef_emxArray_real_T_justina_ekf_T
...
#ifndef typedef_f_cell_wrap_justina_ekf_T
#define typedef_f_cell_wrap_justina_ekf_T

typedef struct tag_pGgszObO16I6TGXaEMnuXB f_cell_wrap_justina_ekf_T;

#endif                                 //typedef_f_cell_wrap_justina_ekf_T
...
{
  emxArray_char_T_justina_ekf_T *Type;
  emxArray_real_T_justina_ekf_T *MotionSubspace;
  real_T JointToParentTransform[16];
  real_T ChildToJointTransform[16];
...
#ifndef typedef_c_rigidBodyJoint_justina_ekf_T
#define typedef_c_rigidBodyJoint_justina_ekf_T

typedef struct tag_QsLFVUgAtzQUBY1V99co0D c_rigidBodyJoint_justina_ekf_T;

#endif                                 //typedef_c_rigidBodyJoint_justina_ekf_T
...
{
  real_T Index;
  c_rigidBodyJoint_justina_ekf_T JointInternal;
  real_T ParentIndex;
  real_T SpatialInertia[36];
};
...
typedef struct tag_vHfXEiuA3KFu0p3XQ6SOuG q_robotics_manip_internal_Rig_T;
...
typedef struct tag_JaIDC5o8TCYfAaNTPWKJe robotics_slmanip_internal_blo_T;
...
{
  f_cell_wrap_justina_ekf_T *data;
  int32_T *size;
  int32_T allocatedSize;
  int32_T numDimensions;
  boolean_T canFreeData;
...
typedef struct P_justina_ekf_T_ P_justina_ekf_T;

// Forward declaration for rtModel
typedef struct tag_RTM_justina_ekf_T RT_MODEL_justina_ekf_T;

#endif                                 // RTW_HEADER_justina_ekf_types_h_
