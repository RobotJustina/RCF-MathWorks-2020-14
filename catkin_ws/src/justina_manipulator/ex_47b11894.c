...
ex_FzXlwsFdzbGOh5RDZi0NNm(real_T*fi,const real_T*basis1,const real_T*
...
n2,const size_t ex_F_tm5fod4xxuguhS49BSQm,const boolean_T
ex_kMAXUIgm88xvaunhJ2st8X,const real_T*work1,const size_t*work2);static void
ex_FokJD1b8z0WJX9TTsQfvSP(real_T*x1,real_T*x2,real_T*fx,const real_T*x1s,const
real_T*x2s,const real_T*fs,const size_t n1,const size_t n2);void
tlu2_2d_akima_nearest_process(real_T*x1,real_T*x2,real_T*fx1,const real_T*x1s,
const real_T*x2s,const real_T*fs,const size_t*n1,const size_t*n2){
ex_FokJD1b8z0WJX9TTsQfvSP(x1,x2,fx1,x1s,x2s,fs,*n1,*n2);}void
...
*)out)[0];real_T*x2=(real_T*)((void**)out)[1];real_T*fx=(real_T*)((void**)out)
[2];tlu2_2d_akima_nearest_process(x1,x2,fx,x1s,x2s,fs,n1,n2);}void
...
size_t*n2=(const size_t*)((const void*const*)in)[4];real_T*x1=(real_T*)((void*
*)out)[0];real_T*x2=(real_T*)((void**)out)[1];real_T*fx=(real_T*)((void**)out)
[2];tlu2_2d_akima_linear_process(x1,x2,fx,x1s,x2s,fs,n1,n2);}static void
ex_FokJD1b8z0WJX9TTsQfvSP(real_T*x1,real_T*x2,real_T*ex_VorZCi5_B5tOa9oe3bnRf5
,const real_T*x1s,const real_T*x2s,const real_T*fs,const size_t n1,const size_t
n2){const size_t ex_F3nVSXkoDK8VeeL5OmY0_B=2;size_t ex__jP7F4Fk5ExlWmUH2CnO0p[
2];const real_T*ex_VToqGBrino_cYuTsjsb5G7[2];const size_t n=n1*n2;real_T*
ex_VsAv95vpmFp3i1E54_unM9=pmf_malloc(n*sizeof(real_T));size_t
ex_FzsezTJVFaKAhHt_a3UeWF;size_t ex_kdATsbeSp_x8_DV4Ry4QD0;size_t
...
ex__jP7F4Fk5ExlWmUH2CnO0p[1]=n2;ex_VToqGBrino_cYuTsjsb5G7[0]=x1;
ex_VToqGBrino_cYuTsjsb5G7[1]=x2;memcpy(x1,x1s,n1*sizeof(real_T));memcpy(x2,x2s
,n2*sizeof(real_T));memcpy(ex_VsAv95vpmFp3i1E54_unM9,fs,n*sizeof(real_T));
ex_F4LajttG6uGtbXBJgUNQpW(x1,x2,ex_VsAv95vpmFp3i1E54_unM9,n1,n2);
ex_FJUlENJSohGphDc_Rf36LU(ex_F3nVSXkoDK8VeeL5OmY0_B,ex__jP7F4Fk5ExlWmUH2CnO0p,
&ex_FzsezTJVFaKAhHt_a3UeWF,&ex_kdATsbeSp_x8_DV4Ry4QD0,&
ex_FP2u25405gSWeDgzM8AO0G);ex_V1PpSt9JShK3bL1Bw6asF1=pmf_malloc(
ex_FzsezTJVFaKAhHt_a3UeWF*sizeof(real_T));ex_VVfVnPxpzepMZXSq9ZSsjY=pmf_malloc
(ex_kdATsbeSp_x8_DV4Ry4QD0*sizeof(size_t));ex_kEWp_Qwr9TpuV5h0iCW4f_(
ex_F3nVSXkoDK8VeeL5OmY0_B,ex__jP7F4Fk5ExlWmUH2CnO0p,ex_VToqGBrino_cYuTsjsb5G7,
ex_VsAv95vpmFp3i1E54_unM9,&ex_V1PpSt9JShK3bL1Bw6asF1[0],&
ex_VVfVnPxpzepMZXSq9ZSsjY[0],ex_VorZCi5_B5tOa9oe3bnRf5);pmf_free(
ex_VsAv95vpmFp3i1E54_unM9);pmf_free(ex_V1PpSt9JShK3bL1Bw6asF1);pmf_free(
ex_VVfVnPxpzepMZXSq9ZSsjY);}void tlu2_2d_akima_nearest_value(real_T*fi,const
real_T*basis1,const real_T*basisDerivative1,const size_t*bin1,const real_T*
basis2,const real_T*basisDerivative2,const size_t*bin2,const real_T*fx1,const
size_t*n1,const size_t*n2,const real_T*work1,const size_t*work2){
ex_FzXlwsFdzbGOh5RDZi0NNm(fi,basis1,basisDerivative1,*bin1,basis2,
basisDerivative2,*bin2,fx1,*n1,*n2,0,false,work1,work2);}void
...
;const real_T*fx=(const real_T*)((const void*const*)in)[6];const size_t*n1=(
const size_t*)((const void*const*)in)[7];const size_t*n2=(const size_t*)((
const void*const*)in)[8];const real_T*work1=(const real_T*)((const void*const*
)in)[9];const size_t*work2=(const size_t*)((const void*const*)in)[10];real_T*
fi=(real_T*)out;tlu2_2d_akima_nearest_value(fi,basis1,basisDerivative1,bin1,
basis2,basisDerivative2,bin2,fx,n1,n2,work1,work2);}void
tlu2_2d_akima_linear_value(real_T*fi,const real_T*basis1,const real_T*
basisDerivative1,const size_t*bin1,const real_T*basis2,const real_T*
basisDerivative2,const size_t*bin2,const real_T*fx1,const size_t*n1,const
size_t*n2,const real_T*work1,const size_t*work2){ex_FzXlwsFdzbGOh5RDZi0NNm(fi,
basis1,basisDerivative1,*bin1,basis2,basisDerivative2,*bin2,fx1,*n1,*n2,1,
false,work1,work2);}void tlu2_2d_akima_linear_value_custom_function_(void*out,
...
void*const*)in)[5];const real_T*fx=(const real_T*)((const void*const*)in)[6];
const size_t*n1=(const size_t*)((const void*const*)in)[7];const size_t*n2=(
const size_t*)((const void*const*)in)[8];const real_T*work1=(const real_T*)((
const void*const*)in)[9];const size_t*work2=(const size_t*)((const void*const*
)in)[10];real_T*fi=(real_T*)out;tlu2_2d_akima_linear_value(fi,basis1,
basisDerivative1,bin1,basis2,basisDerivative2,bin2,fx,n1,n2,work1,work2);}void
tlu2_2d_akima_nearest_derivatives(real_T*fi,const real_T*basis1,const real_T*
basisDerivative1,const size_t*bin1,const real_T*basis2,const real_T*
basisDerivative2,const size_t*bin2,const real_T*fx1,const size_t*n1,const
size_t*n2,const real_T*work1,const size_t*work2){ex_FzXlwsFdzbGOh5RDZi0NNm(fi,
basis1,basisDerivative1,*bin1,basis2,basisDerivative2,*bin2,fx1,*n1,*n2,0,true
,work1,work2);}void tlu2_2d_akima_nearest_derivatives_custom_function_(void*
out,const void*in){const real_T*basis1=(const real_T*)((const void*const*)in)[
0];const real_T*basisDerivative1=(const real_T*)((const void*const*)in)[1];
const size_t*bin1=(const size_t*)((const void*const*)in)[2];const real_T*
basis2=(const real_T*)((const void*const*)in)[3];const real_T*basisDerivative2
=(const real_T*)((const void*const*)in)[4];const size_t*bin2=(const size_t*)((
const void*const*)in)[5];const real_T*fx=(const real_T*)((const void*const*)in
)[6];const size_t*n1=(const size_t*)((const void*const*)in)[7];const size_t*n2
=(const size_t*)((const void*const*)in)[8];const real_T*work1=(const real_T*)(
(const void*const*)in)[9];const size_t*work2=(const size_t*)((const void*const
*)in)[10];real_T*fi=(real_T*)out;tlu2_2d_akima_nearest_derivatives(fi,basis1,
basisDerivative1,bin1,basis2,basisDerivative2,bin2,fx,n1,n2,work1,work2);}void
tlu2_2d_akima_linear_derivatives(real_T*fi,const real_T*basis1,const real_T*
basisDerivative1,const size_t*bin1,const real_T*basis2,const real_T*
basisDerivative2,const size_t*bin2,const real_T*fx1,const size_t*n1,const
size_t*n2,const real_T*work1,const size_t*work2){ex_FzXlwsFdzbGOh5RDZi0NNm(fi,
basis1,basisDerivative1,*bin1,basis2,basisDerivative2,*bin2,fx1,*n1,*n2,1,true
,work1,work2);}void tlu2_2d_akima_linear_derivatives_custom_function_(void*out
,const void*in){const real_T*basis1=(const real_T*)((const void*const*)in)[0];
const real_T*basisDerivative1=(const real_T*)((const void*const*)in)[1];const
size_t*bin1=(const size_t*)((const void*const*)in)[2];const real_T*basis2=(
const real_T*)((const void*const*)in)[3];const real_T*basisDerivative2=(const
...
const size_t*)((const void*const*)in)[8];const real_T*work1=(const real_T*)((
const void*const*)in)[9];const size_t*work2=(const size_t*)((const void*const*
)in)[10];real_T*fi=(real_T*)out;tlu2_2d_akima_linear_derivatives(fi,basis1,
basisDerivative1,bin1,basis2,basisDerivative2,bin2,fx,n1,n2,work1,work2);}
static void ex_FzXlwsFdzbGOh5RDZi0NNm(real_T*fi,const real_T*
...
ex_VorZCi5_B5tOa9oe3bnRf5,const size_t n1,const size_t n2,const size_t
ex_F_tm5fod4xxuguhS49BSQm,const boolean_T ex_kMAXUIgm88xvaunhJ2st8X,const
real_T*work1,const size_t*work2){const size_t n=n1*n2;const size_t
ex_F3nVSXkoDK8VeeL5OmY0_B=2;size_t ex__jP7F4Fk5ExlWmUH2CnO0p[2];const real_T**
ex_kB4aOAnByNCbf5JZPcoQy5=0;const real_T**ex_FNyrrBDfkJhIjyNSa2fMBz=0;const
size_t ex__NJXN1LXJ3dhZPDo3_p2LH=1;real_T*basis[2];real_T*basisDerivative1[2];
real_T*basisDerivative2[2];size_t ex__I2IEgdElv80cD1Kv0uRpM[1];size_t
ex__bBTzednxRh0WT2E2HNmTx[1];size_t*ex_Vic4f_t1_8lMdPxTHOuua8[2];real_T*
ex_V1PpSt9JShK3bL1Bw6asF1;size_t*ex_VVfVnPxpzepMZXSq9ZSsjY;
ex__jP7F4Fk5ExlWmUH2CnO0p[0]=n1;ex__jP7F4Fk5ExlWmUH2CnO0p[1]=n2;basis[0]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_Vl61InPOzylYgiebES6ELs);basis[1]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_kB9XB9hzwwW7Vu4shvxxya);basisDerivative1[0]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_FMWNpeuUHEGegPasHZICvW);basisDerivative1[1]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_kB9XB9hzwwW7Vu4shvxxya);basisDerivative2[0]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_Vl61InPOzylYgiebES6ELs);basisDerivative2[1]=
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_FztrEwsuKLWtXHBYTAffgh);ex__I2IEgdElv80cD1Kv0uRpM
[0]=bin1;ex__bBTzednxRh0WT2E2HNmTx[0]=bin2;ex_Vic4f_t1_8lMdPxTHOuua8[0]=
ex__I2IEgdElv80cD1Kv0uRpM;ex_Vic4f_t1_8lMdPxTHOuua8[1]=
ex__bBTzednxRh0WT2E2HNmTx;ex_V1PpSt9JShK3bL1Bw6asF1=ex_VQMmQUcKA3_3ei3Owj7WVV(
...
+1,ex_VQMmQUcKA3_3ei3Owj7WVV(ex_VorZCi5_B5tOa9oe3bnRf5),basis,&
ex_V1PpSt9JShK3bL1Bw6asF1[0],&ex_VVfVnPxpzepMZXSq9ZSsjY[0],
ex__NJXN1LXJ3dhZPDo3_p2LH,ex_FNyrrBDfkJhIjyNSa2fMBz,ex_Vic4f_t1_8lMdPxTHOuua8,
&fi[0]);}else{ex__I__tR3HVGtUdmAFtUcU_G(ex_F3nVSXkoDK8VeeL5OmY0_B,
ex__jP7F4Fk5ExlWmUH2CnO0p,ex_kB4aOAnByNCbf5JZPcoQy5,ex_F_tm5fod4xxuguhS49BSQm+
1,ex_VQMmQUcKA3_3ei3Owj7WVV(ex_VorZCi5_B5tOa9oe3bnRf5),basisDerivative1,&
ex_V1PpSt9JShK3bL1Bw6asF1[0],&ex_VVfVnPxpzepMZXSq9ZSsjY[0],
ex__NJXN1LXJ3dhZPDo3_p2LH,ex_FNyrrBDfkJhIjyNSa2fMBz,ex_Vic4f_t1_8lMdPxTHOuua8,
&fi[0]);ex__I__tR3HVGtUdmAFtUcU_G(ex_F3nVSXkoDK8VeeL5OmY0_B,
ex__jP7F4Fk5ExlWmUH2CnO0p,ex_kB4aOAnByNCbf5JZPcoQy5,ex_F_tm5fod4xxuguhS49BSQm+
1,ex_VQMmQUcKA3_3ei3Owj7WVV(ex_VorZCi5_B5tOa9oe3bnRf5),basisDerivative2,&
ex_V1PpSt9JShK3bL1Bw6asF1[0],&ex_VVfVnPxpzepMZXSq9ZSsjY[0],
ex__NJXN1LXJ3dhZPDo3_p2LH,ex_FNyrrBDfkJhIjyNSa2fMBz,ex_Vic4f_t1_8lMdPxTHOuua8,
&fi[1]);}}
