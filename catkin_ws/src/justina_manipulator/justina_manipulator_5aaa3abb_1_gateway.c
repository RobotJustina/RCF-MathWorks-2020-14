...
#include "nesl_rtw.h"
#include "justina_manipulator_5aaa3abb_1.h"
#include "justina_manipulator_5aaa3abb_1_gateway.h"

void justina_manipulator_5aaa3abb_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 1, 0.001, 0, 0, 0.004, 0, 0,
    0, 0, (SscLoggingSetting) 0, 523723346, };
  ...
  justina_manipulator_5aaa3abb_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "justina_manipulator/Manipulator/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
