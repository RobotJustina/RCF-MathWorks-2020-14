...
void justina_manipulator_5aaa3abb_1_perturbSimJointPrimitiveState(const void
...
void justina_manipulator_5aaa3abb_1_perturbFlexibleBodyState(const void *mech,
...
void justina_manipulator_5aaa3abb_1_constructStateVector(const void *mech, const
...
void justina_manipulator_5aaa3abb_1_extractSolverStateVector(const void *mech,
...
int justina_manipulator_5aaa3abb_1_isPositionViolation(const void *mech, const
...
int justina_manipulator_5aaa3abb_1_isVelocityViolation(const void *mech, const
  RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const double
  *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId justina_manipulator_5aaa3abb_1_projectStateSim(const void *mech,
...
void justina_manipulator_5aaa3abb_1_computeConstraintError(const void *mech,
...
boolean_T justina_manipulator_5aaa3abb_1_hasJointDisToNormModeChange(const void *
...
PmfMessageId justina_manipulator_5aaa3abb_1_onModeChangedCutJoints(const void
