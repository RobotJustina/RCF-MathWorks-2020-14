...
//
// File: justina_manipulator_types.h
//
...
//
#ifndef RTW_HEADER_justina_manipulator_types_h_
#define RTW_HEADER_justina_manipulator_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_std_msgs_String_
#define DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_std_msgs_String_
...
} SL_Bus_justina_manipulator_std_msgs_String;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_ros_time_Time_
#define DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_ros_time_Time_

// MsgType=ros_time/Time
typedef struct {
  real_T Sec;
  real_T Nsec;
} SL_Bus_justina_manipulator_ros_time_Time;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_std_msgs_Header_
#define DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_std_msgs_Header_
...
typedef struct {
  ...
  // MsgType=ros_time/Time
  SL_Bus_justina_manipulator_ros_time_Time Stamp;
} SL_Bus_justina_manipulator_std_msgs_Header;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_sensor_msgs_JointState_
#define DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_sensor_msgs_JointState_
...
typedef struct {
  ...
  SL_Bus_justina_manipulator_std_msgs_String Name[7];
  ...
  // MsgType=std_msgs/Header
  SL_Bus_justina_manipulator_std_msgs_Header Header;
} SL_Bus_justina_manipulator_sensor_msgs_JointState;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_std_msgs_MultiArrayDimension_
#define DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_std_msgs_MultiArrayDimension_
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_std_msgs_MultiArrayLayout_
#define DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_std_msgs_MultiArrayLayout_
...
typedef struct {
  ...
  SL_Bus_justina_manipulator_std_msgs_MultiArrayDimension Dim[16];

  // IsVarLen=1:VarLenCategory=length:VarLenElem=Dim
  SL_Bus_ROSVariableLengthArrayInfo Dim_SL_Info;
} SL_Bus_justina_manipulator_std_msgs_MultiArrayLayout;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_std_msgs_Float64MultiArray_
#define DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_std_msgs_Float64MultiArray_
...
typedef struct {
  ...
  // MsgType=std_msgs/MultiArrayLayout
  SL_Bus_justina_manipulator_std_msgs_MultiArrayLayout Layout;
} SL_Bus_justina_manipulator_std_msgs_Float64MultiArray;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_std_msgs_Float64_
#define DEFINED_TYPEDEF_FOR_SL_Bus_justina_manipulator_std_msgs_Float64_

// MsgType=std_msgs/Float64
typedef struct {
  real_T Data;
} SL_Bus_justina_manipulator_std_msgs_Float64;
...
typedef struct P_justina_manipulator_T_ P_justina_manipulator_T;

// Forward declaration for rtModel
typedef struct tag_RTM_justina_manipulator_T RT_MODEL_justina_manipulator_T;

#endif                               // RTW_HEADER_justina_manipulator_types_h_
