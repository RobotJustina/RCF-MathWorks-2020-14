...
int32_T sm_ssci_logFcn_codeGen(const NeDae *dae,
  ...
  PmRealVector *output);
extern const NeAssertData justina_manipulator_5aaa3abb_1_assertData[];
extern const NeZCData justina_manipulator_5aaa3abb_1_ZCData[];
void justina_manipulator_5aaa3abb_1_computeRuntimeParameters(
  const double *runtimeRootVariables,
  double *runtimeParameters);
void justina_manipulator_5aaa3abb_1_validateRuntimeParameters(
  const double *runtimeParameters,
  int32_T *assertSatisfactionFlags);
void justina_manipulator_5aaa3abb_1_computeAsmRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
void justina_manipulator_5aaa3abb_1_computeSimRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
PmfMessageId justina_manipulator_5aaa3abb_1_compDerivs(
...
PmfMessageId justina_manipulator_5aaa3abb_1_numJacPerturbLoBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId justina_manipulator_5aaa3abb_1_numJacPerturbHiBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId justina_manipulator_5aaa3abb_1_checkDynamics(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId justina_manipulator_5aaa3abb_1_compOutputsDyn(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId justina_manipulator_5aaa3abb_1_compOutputsKin(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId justina_manipulator_5aaa3abb_1_compOutputs (
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId justina_manipulator_5aaa3abb_1_computeAsmModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId justina_manipulator_5aaa3abb_1_computeSimModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId justina_manipulator_5aaa3abb_1_computeZeroCrossings(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
void justina_manipulator_5aaa3abb_1_setTargets(
...
void justina_manipulator_5aaa3abb_1_resetAsmStateVector(const void *mech, double
  *stateVector);
void justina_manipulator_5aaa3abb_1_resetSimStateVector(const void *mech, double
  *stateVector);
void justina_manipulator_5aaa3abb_1_initializeTrackedAngleState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  ...
  double *stateVector,
  void *neDiagMgr);
void justina_manipulator_5aaa3abb_1_computeDiscreteState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  double *stateVector);
void justina_manipulator_5aaa3abb_1_adjustPosition(
  const void *mech,
  const double *dofDeltas,
  double *stateVector);
void justina_manipulator_5aaa3abb_1_perturbAsmJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  ...
  double *stateVector);
void justina_manipulator_5aaa3abb_1_perturbSimJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void justina_manipulator_5aaa3abb_1_perturbFlexibleBodyState(
  const void *mech,
  size_t stageIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void justina_manipulator_5aaa3abb_1_computePosDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *matrix);
void justina_manipulator_5aaa3abb_1_computeVelDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  const double *stateVector,
  int partialType,
  double *matrix);
void justina_manipulator_5aaa3abb_1_projectPartiallyTargetedPos(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *stateVector);
void justina_manipulator_5aaa3abb_1_propagateMotion(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  double *motionData);
size_t justina_manipulator_5aaa3abb_1_computeAssemblyError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  ...
  const double *motionData,
  double *error);
size_t justina_manipulator_5aaa3abb_1_computeAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  ...
  const double *motionData,
  double *J);
size_t justina_manipulator_5aaa3abb_1_computeFullAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  const double *motionData,
  double *J);
int justina_manipulator_5aaa3abb_1_isInKinematicSingularity(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  const int *modeVector,
  const double *motionData);
PmfMessageId justina_manipulator_5aaa3abb_1_convertStateVector(
  const void *asmMech,
  ...
  void *neDiagMgr);
void justina_manipulator_5aaa3abb_1_constructStateVector(
  const void *mech,
...
void justina_manipulator_5aaa3abb_1_extractSolverStateVector(
  const void *mech,
  const double *fullStateVector,
  double *solverStateVector);
int justina_manipulator_5aaa3abb_1_isPositionViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
int justina_manipulator_5aaa3abb_1_isVelocityViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
PmfMessageId justina_manipulator_5aaa3abb_1_projectStateSim(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const int *modeVector,
  ...
  double *stateVector,
  void *neDiagMgr);
void justina_manipulator_5aaa3abb_1_computeConstraintError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  double *error);
void justina_manipulator_5aaa3abb_1_resetModeVector(const void *mech, int
  *modeVector);
boolean_T justina_manipulator_5aaa3abb_1_hasJointDisToNormModeChange(
  const void *mech,
  const int *prevModeVector,
  const int *modeVector);
PmfMessageId justina_manipulator_5aaa3abb_1_performJointDisToNormModeChange(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *prevModeVector,
  const int *modeVector,
  ...
  double *stateVector,
  void *neDiagMgr);
PmfMessageId justina_manipulator_5aaa3abb_1_onModeChangedCutJoints(
  const void *mech,
  const int *prevModeVector,
  int *modeVector,
  double *stateVector,
  void *neDiagMgr);
PmfMessageId justina_manipulator_5aaa3abb_1_assemble(const double *u, double
  *udot, double *x,
  NeuDiagnosticManager *neDiagMgr)
{
  (void) x;
  ...
  const NeParameterBundle *paramBundle)
{
  ...
  if (smData->mRuntimeParameterScalars.mN == 0)
    return;
  justina_manipulator_5aaa3abb_1_computeRuntimeParameters(
    runtimeRootVariables,
    smData->mRuntimeParameterScalars.mX);
  justina_manipulator_5aaa3abb_1_computeAsmRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
    &dae->mPrivateData->mAsmRuntimeDerivedValuesBundle);
  justina_manipulator_5aaa3abb_1_computeSimRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  (void) systemInput;
  (void) neDiagMgr;
  justina_manipulator_5aaa3abb_1_validateRuntimeParameters(
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mCachedDerivativesAvailable)
    ...
    errorId = justina_manipulator_5aaa3abb_1_compDerivs(
      &smData->mSimRuntimeDerivedValuesBundle,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = justina_manipulator_5aaa3abb_1_numJacPerturbLoBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = justina_manipulator_5aaa3abb_1_numJacPerturbHiBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  errorId = justina_manipulator_5aaa3abb_1_compOutputs(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mM.mX,
    systemInput->mU.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = justina_manipulator_5aaa3abb_1_computeSimModeVector(
    systemInput->mU.mX,
    systemInput->mU.mX + 8,
    systemInput->mV.mX + 8,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  double errorResult = 0.0;
  return
    justina_manipulator_5aaa3abb_1_computeZeroCrossings(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mU.mX,
    systemInput->mU.mX + 8,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (errorId == NULL && smData->mDoCheckDynamics) {
    double result = 0.0;
    errorId = justina_manipulator_5aaa3abb_1_checkDynamics(
      &smData->mSimRuntimeDerivedValuesBundle,
      systemInput->mX.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 8,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mAssemblyModeVector.mN > 0) {
    errorId = justina_manipulator_5aaa3abb_1_computeAsmModeVector(
      systemInput->mU.mX,
      systemInput->mU.mX + 8,
      systemInput->mV.mX + 8,
  ...
  justina_manipulator_5aaa3abb_1_checkTargets(
    &smData->mSimRuntimeDerivedValuesBundle,
...
static void initAsserts(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumParamAsserts > 0) {
    const NeAssertData *ad = justina_manipulator_5aaa3abb_1_assertData;
    size_t i;
...
static void initZeroCrossings(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumZeroCrossings > 0) {
    const NeZCData *zcd = justina_manipulator_5aaa3abb_1_ZCData;
    size_t i;
  ...
  void initVariables(NeDaePrivateData *smData)
{
  ...
  const char *varObjects[14] = {
    "justina_manipulator/Manipulator/la_1_joint",
    "justina_manipulator/Manipulator/la_1_joint",
    "justina_manipulator/Manipulator/la_2_joint",
    "justina_manipulator/Manipulator/la_2_joint",
    "justina_manipulator/Manipulator/la_3_joint",
    "justina_manipulator/Manipulator/la_3_joint",
    "justina_manipulator/Manipulator/la_4_joint",
    "justina_manipulator/Manipulator/la_4_joint",
    "justina_manipulator/Manipulator/la_5_joint",
    "justina_manipulator/Manipulator/la_5_joint",
    "justina_manipulator/Manipulator/la_6_joint",
    "justina_manipulator/Manipulator/la_6_joint",
    "justina_manipulator/Manipulator/la_7_joint",
    "justina_manipulator/Manipulator/la_7_joint"
  };
  ...
  void initAssemblyDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mSetTargets = justina_manipulator_5aaa3abb_1_setTargets;
  delegate->mResetStateVector =
    justina_manipulator_5aaa3abb_1_resetAsmStateVector;
  delegate->mInitializeTrackedAngleState =
    justina_manipulator_5aaa3abb_1_initializeTrackedAngleState;
  delegate->mComputeDiscreteState =
    justina_manipulator_5aaa3abb_1_computeDiscreteState;
  delegate->mAdjustPosition = justina_manipulator_5aaa3abb_1_adjustPosition;
  delegate->mPerturbJointPrimitiveState =
    justina_manipulator_5aaa3abb_1_perturbAsmJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState = NULL;
  delegate->mComputePosDofBlendMatrix =
    justina_manipulator_5aaa3abb_1_computePosDofBlendMatrix;
  delegate->mComputeVelDofBlendMatrix =
    justina_manipulator_5aaa3abb_1_computeVelDofBlendMatrix;
  delegate->mProjectPartiallyTargetedPos =
    justina_manipulator_5aaa3abb_1_projectPartiallyTargetedPos;
  delegate->mPropagateMotion = justina_manipulator_5aaa3abb_1_propagateMotion;
  delegate->mComputeAssemblyError =
    justina_manipulator_5aaa3abb_1_computeAssemblyError;
  delegate->mComputeAssemblyJacobian =
    justina_manipulator_5aaa3abb_1_computeAssemblyJacobian;
  delegate->mComputeFullAssemblyJacobian =
    justina_manipulator_5aaa3abb_1_computeFullAssemblyJacobian;
  delegate->mIsInKinematicSingularity =
    justina_manipulator_5aaa3abb_1_isInKinematicSingularity;
  delegate->mConvertStateVector =
    justina_manipulator_5aaa3abb_1_convertStateVector;
  ...
  void initSimulationDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mResetStateVector =
    justina_manipulator_5aaa3abb_1_resetSimStateVector;
  delegate->mInitializeTrackedAngleState = NULL;
  delegate->mComputeDiscreteState = NULL;
  delegate->mAdjustPosition = NULL;
  delegate->mPerturbJointPrimitiveState =
    justina_manipulator_5aaa3abb_1_perturbSimJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState =
    justina_manipulator_5aaa3abb_1_perturbFlexibleBodyState;
  ...
  delegate->mConstructStateVector =
    justina_manipulator_5aaa3abb_1_constructStateVector;
  delegate->mExtractSolverStateVector =
    justina_manipulator_5aaa3abb_1_extractSolverStateVector;
  delegate->mIsPositionViolation =
    justina_manipulator_5aaa3abb_1_isPositionViolation;
  delegate->mIsVelocityViolation =
    justina_manipulator_5aaa3abb_1_isVelocityViolation;
  delegate->mProjectStateSim = justina_manipulator_5aaa3abb_1_projectStateSim;
  delegate->mComputeConstraintError =
    justina_manipulator_5aaa3abb_1_computeConstraintError;
  delegate->mResetModeVector = justina_manipulator_5aaa3abb_1_resetModeVector;
  delegate->mHasJointDisToNormModeChange =
    justina_manipulator_5aaa3abb_1_hasJointDisToNormModeChange;
  delegate->mPerformJointDisToNormModeChange =
    justina_manipulator_5aaa3abb_1_performJointDisToNormModeChange;
  delegate->mOnModeChangedCutJoints =
    justina_manipulator_5aaa3abb_1_onModeChangedCutJoints;
  delegate->mMech = NULL;
}
...
void justina_manipulator_5aaa3abb_1_NeDaePrivateData_create(NeDaePrivateData
  *smData)
{
